...
contract MockLendingVault is ERC20, ReentrancyGuard, Pausable, Ownable2Step, ILendingVault {
  ...
  */
  ...
  /**
    ...
    * @param _interestRate  InterestRate struct
  ...
  */
  ...
  /* ========== MOCK FUNCTIONS ========== */
  function mockSetDebt(address borrower, uint256 debt) external {
    borrowers[borrower].debt = debt;
  }
  ...
  */
  function withdrawReserve(uint256 assetAmt) external nonReentrant {
    // Update vault with accrued interest and latest timestamp
    _updateVaultWithInterestsAndTimestamp(0);
  ...
  /**
    * @dev Allow only approved borrower addresses
  */
  function _onlyBorrower() public view {
  ...
  /**
    * @dev Allow only keeper addresses
  */
  function _onlyKeeper() public view {
  ...
  */
  function _updateVaultWithInterestsAndTimestamp(uint256 assetAmt) public {
  ...
  */
  function _pendingInterest(uint256 assetAmt) public view returns (uint256) {
  ...
  */
  function _to18ConversionFactor() public view returns (uint256) {
    unchecked {
  ...
  */
  function _calculateInterestRate(uint256 debt, uint256 floating) public view returns (uint256) {
